...
## [0.7.1](https://github.com/near/sandbox/compare/v0.7.0...v0.7.1) - 2024-03-26

### Added
- Update default nearcore version to v1.38.0 ([#81](https://github.com/near/sandbox/pull/81))
- use tokio instead of async-process as dependants use tokio runtime anyway ([#68](https://github.com/near/sandbox/pull/68))
...
- add aws link to rust crate ([#18](https://github.com/near/sandbox/pull/18))
- near-sandbox cargo crate for installing sandbox

### Fixed
- pin async-process crate ([#66](https://github.com/near/sandbox/pull/66))

### Other
- use SANDBOX_ARTIFACT_URL ([#74](https://github.com/near/sandbox/pull/74))
- 0.7.0 ([#69](https://github.com/near/sandbox/pull/69))
- release ([#67](https://github.com/near/sandbox/pull/67))
...
- Merge pull request [#33](https://github.com/near/sandbox/pull/33) from near/update/sandbox-version
